...
class ImagePreviewDialog(QDialog):
    def __init__(self, image_path, parent=None):
        ...
        self.setWindowFlags(self.windowFlags() | Qt.WindowMaximizeButtonHint | Qt.WindowMinimizeButtonHint | Qt.FramelessWindowHint)
        ...
        close_icon_path = os.path.abspath(os.path.join(os.path.dirname(__file__), "icons", "close_icon.png"))
        self.close_button.setIcon(QIcon(close_icon_path))  # 替换为实际的关闭图标路径
