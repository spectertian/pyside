...
class ImagePreviewDialog(QDialog):
    def __init__(self, image_path, parent=None):
        ...
        print(f"Pixmap is null: {self.original_pixmap.isNull()}")
        print(f"Pixmap size: {self.original_pixmap.size()}")
    ...
    def paintEvent(self, event):
        ...
        if self.image_label.pixmap():
            ...
            icon_size = 40
            tooltip_rect = QRect(
                pixmap_rect.right() - icon_size - 10,
                pixmap_rect.bottom() - icon_size - 10,
                icon_size,
                icon_size
            )
            ...
            painter.drawText(tooltip_rect, Qt.AlignCenter, "i")
            ...
            self.tooltip_rect = tooltip_rect
